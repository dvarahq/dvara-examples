...
echo -n "$GATEWAY_METRICS_API_KEY" > grafana/gateway-metrics-api-key
...
scrape_configs:
  - job_name: dvara-gateway
    ...
    bearer_token: "<paste GATEWAY_METRICS_API_KEY here>"
    static_configs:
